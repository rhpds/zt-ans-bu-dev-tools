...
. *Open the collection folder in VS Code.* In the top menu, select **File** → **Open Folder...**, enter the following path and click **OK**:
+
...
. *Open the VS Code Terminal* from the top menu: **Terminal** → **New Terminal**
