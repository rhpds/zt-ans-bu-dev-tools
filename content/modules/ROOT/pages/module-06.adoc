...
* **Tag:** mycollection-ee
+ Leave the other fields as they are. We will customize the execution environment file soon.
...
You have successfully packaged your automation content into an Execution Environment using `ansible-builder` and VS Code. This image is now ready for promotion to an Automation Hub or deployment via Automation Controller.
