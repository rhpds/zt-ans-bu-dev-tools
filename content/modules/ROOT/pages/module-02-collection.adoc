...
.   **Locate and open the Ansible extension icon on the sidebar of VS Code** and click on it. You will see the Ansible sidebar with the *Ansible Development Tools* section.
+
